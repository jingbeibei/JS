    ...
    AFUi.prototype = {
       ...
       /**
        ...
        loadContentData: function(what,view,back,isNewView) {
            ...
            this.showBackButton(what, view,isNewView);
         ...
         */
        showBackButton:function(newPanel, view,isNewView) {
            var items=(this.views[view.prop("id")].length);
            var hdr=view.children("header");
            if(hdr.length===0) return;

            var hideBack = $(newPanel).data('hide-back')
            // alert(hideBack)

            if(items >= 2 && isNewView !== true && !hideBack){
        ...
        launch: function() {
            ...
            var maskDiv = $.create("div", {
                id: "afui_mask",
                className: "ui-loader",
                html: "<div class='icon loading spin'></div><h1>Loading Content</h1>"
            }).css({
                "z-index": 20000,
                display: "none"
            });
